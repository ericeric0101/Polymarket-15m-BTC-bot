...
- Market rows：429（local journal markets 235；public-history markets 200）；public trades：178,113。
...
|---|---:|---:|---:|---:|---:|
| public_trade_count | 100 / 928.9600 | 100 / 852.1700 | -76.7900 | [-213.1955, 46.7060] | 0.2549 |
| public_volume_shares | 100 / 27199.3799 | 100 / 23139.7271 | -4059.6528 | [-10700.7156, 1273.0233] | 0.2164 |
| median_trade_size | 98 / 8.9581 | 99 / 8.7278 | -0.2303 | [-0.7287, 0.2732] | 0.3943 |
| max_no_trade_interval_sec | 100 / 61.4400 | 100 / 47.5600 | -13.8800 | [-46.0810, 16.9367] | 0.3368 |
| realized_volatility | 83 / 0.6417 | 88 / 0.6747 | 0.0330 | [-0.0396, 0.1037] | 0.3623 |
...
- weekday n=100：Gamma success 100；trades success/empty/other 98/2/0；prices success/empty/other 83/17/0。
- weekend n=100：Gamma success 100；trades success/empty/other 99/1/0；prices success/empty/other 88/12/0。
...
|---|---:|---:|---:|---:|---:|---:|---:|
| public_trade_count | 8 | 913.1125 | 846.4851 | -66.6274 | [-203.7302, 85.9908] | 0.4453 | 6 |
| public_volume_shares | 8 | 26468.4808 | 22833.7693 | -3634.7115 | [-8739.2075, 2777.6853] | 0.2812 | 6 |
| median_trade_size | 8 | 8.9715 | 8.7349 | -0.2366 | [-1.2001, 0.7406] | 0.6875 | 4 |
| max_no_trade_interval_sec | 8 | 65.2958 | 46.6935 | -18.6024 | [-55.9050, 16.4841] | 0.3125 | 4 |
| realized_volatility | 7 | 0.6368 | 0.6731 | 0.0363 | [-0.0249, 0.1004] | 0.3594 | 3 |
...
- Requested markets：200；identity resolved：200。
- Gamma success：200；local identity used while Gamma unavailable：0；identifier mismatch：0。
- Trade fetch success/empty/failed/not-fetched：197 / 3 / 0 / 0；matching trades：178113。
- Excluded identity-mismatched trades：0。
- Price fetch success/empty/failed/not-fetched：171 / 29 / 0 / 0；price points：1702。
