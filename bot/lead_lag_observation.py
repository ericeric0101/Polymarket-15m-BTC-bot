...
class LeadLagObservationMixin:
    ...
    def _lead_lag_snapshot_payload(self, *, slug: str, now_ts: float, up_mid: Optional[float]) -> dict[str, Any]:
        ...
        return {
            ...
            "hyperliquid_outcome_stream_ready": bool(outcome.get("stream_ready", False)),
            "hyperliquid_outcome_connection_attempt_count": outcome.get("connection_attempt_count"),
            "hyperliquid_outcome_disconnect_count": outcome.get("disconnect_count"),
            "hyperliquid_outcome_consecutive_disconnects": outcome.get("consecutive_disconnects"),
            "hyperliquid_outcome_reconnect_delay_sec": outcome.get("reconnect_delay_sec"),
            "hyperliquid_outcome_last_disconnect_error": outcome.get("last_disconnect_error"),
            "hyperliquid_outcome_last_message_age_sec": outcome.get("last_message_age_sec"),
            "hyperliquid_outcome_last_valid_data_age_sec": outcome.get("last_valid_data_age_sec"),
